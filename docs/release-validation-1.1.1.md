...
Version 1.1.1 is a patch release for dispatch result-table generation. It
consolidates wide Pandas result frames between accounting phases so simulations
that generate many per-asset columns do not emit DataFrame fragmentation
warnings. The release preserves configuration schemas 1 and 2 and output schema
version 1.
